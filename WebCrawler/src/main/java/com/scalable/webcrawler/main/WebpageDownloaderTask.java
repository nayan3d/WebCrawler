...
import com.scalable.webcrawler.dao.CrawlerDAO;
import com.scalable.webcrawler.entities.WebLink;
import com.scalable.webcrawler.util.HttpConnect;
import com.scalable.webcrawler.util.IOUtil;

public class WebpageDownloaderTask implements Runnable, WebPageDownloader {
	
	private static CrawlerDAO dao = new CrawlerDAO();
	...
	private static class Downloader<T extends WebLink> implements Callable<T> {
		...
		public T call() {
			System.out.println("WebPage to google "+weblink.getHtmlPage());
			try {
	...
	/* (non-Javadoc)
	 * @see com.scalable.webcrawler.main.WebPageDownloader#run()
	 */
	@Override
	public void run() {
